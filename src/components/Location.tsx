...
const Location = () => {
  ...
  return (
    <div
      className="bg-primary text-center py-16 px-4 sm:py-20"
      style={{
    ...
    >
      ...
      <p className="max-w-3xl mx-auto text-lg sm:text-xl mt-2 font-helvetica px-5 text-gris">
        Nos encantaría que nos acompañes en este día tan especial para nosotros.
      </p>

      {/* Cuenta regresiva */}
      <div className="max-w-4xl mx-auto mt-10">
        <h3 className="text-2xl font-birds-of-paradise tracking-wider text-tertiary mb-4">
          Cuenta regresiva
        </h3>
